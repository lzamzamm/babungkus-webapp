    ...
    <div class="font-poppins">
      ...
      <div class="hp:text-[1.6vmax] flex lg:flex-row hp:flex-col pt-[7.5%] pl-[10%] pr-[10%]">
        <div class=" hp:w-full lg:w-[30vmax]">
          <img
            src={Food_1}
            class="w-full lg:h-[15.5vmax] hp:h-[17.5vmax] bg-slate-300 lg:rounded-[1.5vmax]"
          />
          <div class="w-full lg:h-[2vmax] hp:h-[1vmax] bg-white" />
          <img
            src={Food_2}
            class="w-full lg:h-[15.5vmax] hp:h-[17.5vmax] bg-slate-600 lg:rounded-[1.5vmax]"
          />
        </div>
